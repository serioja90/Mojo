...
# Generated by qmake (2.01a) (Qt 4.8.3) on: mer feb 13 00:39:18 2013
# Project:  Mojo.pro
# Template: app
...
SOURCES       = src/main.cpp \
		...
		src/Polygon.cpp \
		src/Object.cpp \
		src/Exception.cpp build/moc/moc_MainWindow.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/obj/Mojo1.0.0/ && $(COPY_FILE) --parents src/include/MainWindow.h src/include/GLWidget.h src/include/XmlParser.h src/include/Color.h src/include/Point.h src/include/Exception.h src/include/Line.h src/include/Triangle.h src/include/Quad.h src/include/Polygon.h src/include/Object.h build/obj/Mojo1.0.0/ && $(COPY_FILE) --parents resources/icons.qrc build/obj/Mojo1.0.0/ && $(COPY_FILE) --parents src/main.cpp src/MainWindow.cpp src/GLWidget.cpp src/XmlParser.cpp src/Color.cpp src/Point.cpp src/Line.cpp src/Triangle.cpp src/Quad.cpp src/Polygon.cpp src/Object.cpp src/Exception.cpp build/obj/Mojo1.0.0/ && (cd `dirname build/obj/Mojo1.0.0` && $(TAR) Mojo1.0.0.tar Mojo1.0.0 && $(COMPRESS) Mojo1.0.0.tar) && $(MOVE) `dirname build/obj/Mojo1.0.0`/Mojo1.0.0.tar.gz . && $(DEL_FILE) -r build/obj/Mojo1.0.0
