...
# Generated by qmake (2.01a) (Qt 4.8.3) on: mar mar 12 14:02:54 2013
# Project:  Mojo.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/obj/Mojo1.0.0/ && $(COPY_FILE) --parents src/include/MainWindow.h src/include/Exception.h src/include/GLWidget.h src/include/XmlParser.h src/include/Color.h src/include/Point.h src/include/Line.h src/include/Triangle.h src/include/Quad.h src/include/Polygon.h src/include/MaterialParameter.h src/include/AmbientParameter.h src/include/DiffuseParameter.h src/include/SpecularParameter.h src/include/ShininessParameter.h src/include/EmissionParameter.h src/include/Material.h src/include/Quadric.h src/include/Sphere.h src/include/Object.h build/obj/Mojo1.0.0/ && $(COPY_FILE) --parents resources/icons.qrc build/obj/Mojo1.0.0/ && $(COPY_FILE) --parents src/main.cpp src/Exception.cpp src/MainWindow.cpp src/GLWidget.cpp src/XmlParser.cpp src/Color.cpp src/Point.cpp src/Line.cpp src/Triangle.cpp src/Quad.cpp src/Polygon.cpp src/MaterialParameter.cpp src/AmbientParameter.cpp src/DiffuseParameter.cpp src/SpecularParameter.cpp src/ShininessParameter.cpp src/EmissionParameter.cpp src/Material.cpp src/Quadric.cpp src/Sphere.cpp src/Object.cpp build/obj/Mojo1.0.0/ && (cd `dirname build/obj/Mojo1.0.0` && $(TAR) Mojo1.0.0.tar Mojo1.0.0 && $(COMPRESS) Mojo1.0.0.tar) && $(MOVE) `dirname build/obj/Mojo1.0.0`/Mojo1.0.0.tar.gz . && $(DEL_FILE) -r build/obj/Mojo1.0.0
